...
public class PortfolioExcelParser {
    ...
    public List<PortfolioUploadRow> parse(MultipartFile file) {
        log.info("Parsing portfolio Excel file. fileName={}", file != null ? file.getOriginalFilename() : null);
        ...
        try (InputStream inputStream = file.getInputStream()) {
            ...
            log.error("Failed to parse portfolio Excel file. fileName={}", file != null ? file.getOriginalFilename() : null, e);
            throw new RuntimeException("Failed to parse Excel file", e);
        }
        log.info("Portfolio Excel parsing completed. fileName={}, rowCount={}", file != null ? file.getOriginalFilename() : null, rows.size());
        return rows;
    }
